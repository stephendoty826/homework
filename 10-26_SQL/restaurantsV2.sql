...
-- (DEFAULT, 'Bobby', 'bobbynewportn@hotmail.com', 0),
...
-- (DEFAULT, 7, 4, 'Slow service', 'Service was slow but food was good when we got it.', 13),
-- (DEFAULT, 8, 3, 'Great Experience', 'Food was great and employees were so nice.', 14),
-- (DEFAULT, 1, 2.5, 'Would not go again', 'Restaurant was dirty and employees were rude. Food was OK.', 15),
-- (DEFAULT, 2, 2, 'Have to go again.', 'Great food. Wonderfull experience and atmosphere.', 16),
-- (DEFAULT, 3, 5, 'Why???', 'My only complaint is that this restaurant is on the other side of town.', 17),
-- (DEFAULT, 4, 4, 'How much food can you eat', 'Food was great. Portions were big.', 18),
